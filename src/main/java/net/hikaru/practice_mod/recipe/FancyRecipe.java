...
public class FancyRecipe implements Recipe<SimpleInventory> {
    private final Identifier id;
    private final ItemStack output;
    private final DefaultedList<Ingredient> recipeItems;

    public FancyRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<FancyRecipe> {
        ...
        public FancyRecipe read(Identifier id, JsonObject json) {
            ...
            return new FancyRecipe(id, output, inputs);
        }

        @Override
        public FancyRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, FancyRecipe recipe) {
