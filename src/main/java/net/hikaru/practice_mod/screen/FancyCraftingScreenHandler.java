...
public class FancyCraftingScreenHandler extends ScreenHandler {
    ...
    public FancyCraftingScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(3), new ArrayPropertyDelegate(2));
    }

    public FancyCraftingScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory,
    ...
    public FancyCraftingScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.FANCY_CRAFTING_SCREEN_HANDLER, syncId);
        checkSize(inventory, 3);
        this.inventory = inventory;
        inventory.onOpen(playerInventory.player);
